...
<title>Create New Individual Contact</title>
...
<body>
	<br>
	<s:form action="create_individual_contact" method="post" theme="simple">
		<s:radio name="contact_type" label="Type of Contact "
			...
			<s:div>
				<s:textfield name="phone_person" placeholder="Enter your phone number"
					label="Your Phone No." theme="xhtml" />
