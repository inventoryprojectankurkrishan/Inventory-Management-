		...
		<s:form action="register" method="post" theme="simple">
			...
			<s:div>
				<s:textfield name="userid" label="User Id "
					placeholder="Create a new unique User Id" theme="xhtml" />
			</s:div>
			<br>
			<s:div>
				<s:password name="password" label="Password"
					placeholder="At least 6 characterss" theme="xhtml" />
			</s:div>
			<br>
			<s:div>
				<s:password name="confirmpassword" label="Reenter password"
					placeholder="please reenter your password" theme="xhtml" />
			</s:div>
			<br>
			<s:div>
				<s:textfield name="phone" placeholder="Enter your phone number"
					label="Phone No." theme="xhtml" />
			</s:div>
			<br>
			<s:div>
